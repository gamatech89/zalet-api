...
<head>
  ...
  <title>Pretplata ističe – Zalet</title>
</head>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;margin:0 auto;">
          ...
          <tr>
            <td style="background-color:#1a1a1a;border:1px solid #2a2a2a;border-radius:20px;padding:40px 36px;">
              ...
              <p style="margin:0 0 4px;color:#f59e0b;font-size:13px;font-weight:600;text-align:center;letter-spacing:0.06em;">PODSETNIK</p>
              <p style="margin:0 0 8px;color:#fff;font-size:24px;font-weight:700;text-align:center;">
                Pretplata ističe za {{ $daysLeft }} {{ $daysLeft === 1 ? 'dan' : 'dana' }}
              </p>
              <p style="margin:0 0 28px;color:#888;font-size:15px;text-align:center;line-height:1.6;">
                Tvoja {{ $planName }} pretplata važi do <strong style="color:#ccc;">{{ $endsAt }}</strong>.
                Obnovi je na vreme da ne izgubiš pristup.
              </p>
